...
\spa{
    \begin{picture}(0,0)
    \put(0,-60){\includegraphics[scale=0.18]{fotoCV}}
    \end{picture}
}
...
\cventry
    ...
    {Universidad de Buenos Aires, Facultad de Ingeniería}{}{}
    {\spa{Calificaciones distinguidas:}\en{Distinguished grades (Grading Scale: 1 to 10)}
    \begin{itemize}
