...
\cventry
    {\spa{2016--Actualidad}\en{2016--Now}}
    {\spa{Estudiante de Ingeniería en Informática}\en{Computer Engineering student}}
    {Universidad de Buenos Aires, Facultad de Ingeniería}{}{}{
        \spa{Calificaciones distinguidas}\en{Outstanding grades}:
        \begin{itemize}
            \item Algoritmos y Programación I - Distinguido (8)
            \item Algoritmos y Programación II - Distinguido (9)
            \item Organización de Datos - Sobresaliente (10)
            \item Teoría de Algoritmos I - Sobresaliente (10)
            \item Sistemas Operativos - Sobresaliente (10)
        \end{itemize}
    }
